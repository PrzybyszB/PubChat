...
W pierwszej kolejności przeanalizowałem strukturę demograficzną uczestników badania - wynik przedstawiono na Rysunku 2.1.
...
Po przygotowaniu końcowego zbioru analitycznego przeprowadzono analizę spożycia błonnika pokarmowego. W pierwszej kolejności obliczono podstawowe statystyki opisowe. W celu lepszej wizualizacji rozkładu spożycia błonnika przygotowano tabelę z wynikami (Tabela 2.1).
<!-- ```{python}
#| echo: false
#| label: tbl-fiber-table
#| tbl-cap: "Wyniki analizy spożycia błonnika"
engine = create_engine(
    "postgresql://postgres:postgres@localhost:5432/diploma_db"
)
...
Tabela 2.2. Wyniki analizy spożycia błonnika pokarmowego w badanej populacji.
...
<!-- ```{python}
#| echo: false
#| label: tbl-sodium-table
#| tbl-cap: "Wyniki analizy spożycia sodu"
...
print(sodium_table.to_markdown(index=False, floatfmt=".1f"))
``` -->
