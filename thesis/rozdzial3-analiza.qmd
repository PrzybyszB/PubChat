...
```{python}
#| echo: false
#| #| label: fig-publication-fiber-table
#| fig-cap: "Publikacje naukowe zwrócone przez moduł Retrieval dla scenariusza niedoboru błonnika"
from app.services.retriever import retrieve_articles, QUERY_MAP
import pandas as pd

fiber_articles = retrieve_articles(
    ...
    [
        {
            ...
            "Typ publikacji": article["publication_type"],
            "Ocena końcowa": article["llm_final_score"],
            "Ocena Retrieval": round(article["retrieval_score"], 3),
            "Tytuł publikacji": article["title"]
        }
        for article in fiber_articles
    ]
)
```
...
```{python}
#| echo: false
#| #| label: fig-publication-sodium-table
#| fig-cap: "Publikacje naukowe zwrócone przez moduł Retrieval dla scenariusza podwyższonego sodu"
from app.services.retriever import retrieve_articles, QUERY_MAP
import pandas as pd

sodium_articles = retrieve_articles(
...
pd.DataFrame(
    [
        ...
        for article in sodium_articles
    ]
)
```
